...
export const MOCK_NEWS: NewsItem[] = [
  {
    ...
    date: 'May 11, 2026',
    image: '',
    excerpt: 'The Joint Admissions and Matriculation Board (JAMB) holds its annual Policy Meeting on admissions into tertiary institutions in Nigeria, determining cut-off marks and admission guidelines for the 2026/2027 academic session.',
