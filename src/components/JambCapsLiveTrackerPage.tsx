        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-600 dark:text-emerald-400 font-bold text-[11px] uppercase tracking-wider mb-2">
              ...
              Official JAMB CAPS Live Feed • 2026/2027 Session
            </div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1 max-w-2xl">
              Live telemetry mirroring the official JAMB database portal (`caps.jamb.gov.ng/dashboard.aspx`). Monitor real-time admissions, candidate quotas, O'Level stats, and daily approvals.
            </p>
          </div>

          <div className="flex items-center gap-3 shrink-0">
            <span className="text-xs text-gray-400 font-medium hidden sm:inline">
              Synced: <strong className="text-gray-700 dark:text-gray-200">August 26, 2026</strong>
            </span>
            <button
              onClick={handleRefresh}
              disabled={isRefreshing}
              className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-700 dark:text-gray-300 font-bold text-xs transition-all active:scale-95 shadow-sm disabled:opacity-50"
            >
          ...
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-gradient-to-br from-emerald-600 to-emerald-900 text-white p-6 rounded-[28px] shadow-xl relative overflow-hidden">
                ...
                <h3 className="text-4xl font-black mt-2 tracking-tight">1,798</h3>
              ...
              <div className="bg-gradient-to-br from-purple-600 to-purple-900 text-white p-6 rounded-[28px] shadow-xl relative overflow-hidden">
                ...
                <h3 className="text-4xl font-black mt-2 tracking-tight">2,275,690</h3>
              ...
              <div className="bg-gradient-to-br from-amber-600 to-amber-900 text-white p-6 rounded-[28px] shadow-xl relative overflow-hidden">
                ...
                <h3 className="text-4xl font-black mt-2 tracking-tight">76,212</h3>
              ...
              <div className="bg-gradient-to-br from-blue-600 to-blue-900 text-white p-6 rounded-[28px] shadow-xl relative overflow-hidden">
                ...
                <h3 className="text-4xl font-black mt-2 tracking-tight">2,128,252</h3>
              ...
              <div className="bg-gradient-to-br from-red-600 to-red-900 text-white p-6 rounded-[28px] shadow-xl relative overflow-hidden">
                ...
                <h3 className="text-4xl font-black mt-2 tracking-tight">2,204,464</h3>
              ...
              <div className="bg-gradient-to-br from-rose-700 to-rose-950 text-white p-6 rounded-[28px] shadow-xl relative overflow-hidden">
                ...
                <h3 className="text-4xl font-black mt-2 tracking-tight">2,048,324</h3>
          ...
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 p-6 rounded-[28px] shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  { label: "O'Level Results Uploaded (UTME & DE)", val: "1,118,222", desc: "Total candidates with verified O'Level results uploaded on CAPS" },
                  { label: "5 O'Level Credits, 100+ & DE", val: "1,096,181", desc: "Obtained 5 credit passes with UTME score 100+" },
                  { label: "5 O'Level Credits, 140+ & DE", val: "1,078,461", desc: "Obtained 5 credit passes with UTME score 140+" },
                  { label: "5 O'Level Credits, (100+) + English + DE", val: "1,075,895", desc: "Includes compulsory English Language credit" },
                  { label: "5 O'Level Credits, (100+) + English/Maths + DE", val: "1,065,891", desc: "Includes English or Mathematics credit" },
                  { label: "5 O'Level Credits, (140+) + English + DE", val: "1,059,078", desc: "Score 140+ with English credit pass" },
                  { label: "5 O'Level Credits, (140+) + Eng + Maths + DE", val: "1,049,415", desc: "Full requirement: Score 140+, English & Mathematics credits" },
                ].map((item, idx) => (
            ...
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 p-6 rounded-[28px] shadow-sm space-y-6">
              <div>
                ...
                <p className="text-xs text-gray-500">
                  Real-time admissions pipeline movement for Wednesday, August 26, 2026 across Nigerian tertiary institutions.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="bg-blue-50 dark:bg-blue-900/10 p-6 rounded-2xl border border-blue-100 dark:border-blue-900/30 text-center">
                  ...
                  <h3 className="text-3xl font-black text-gray-900 dark:text-white mt-3">751</h3>
                ...
                <div className="bg-purple-50 dark:bg-purple-900/10 p-6 rounded-2xl border border-purple-100 dark:border-purple-900/30 text-center">
                  ...
                  <h3 className="text-3xl font-black text-gray-900 dark:text-white mt-3">1,155</h3>
                ...
                <div className="bg-amber-50 dark:bg-amber-900/10 p-6 rounded-2xl border border-amber-100 dark:border-amber-900/30 text-center">
                  ...
                  <h3 className="text-3xl font-black text-gray-900 dark:text-white mt-3">1,625</h3>
                ...
                <div className="bg-emerald-50 dark:bg-emerald-900/10 p-6 rounded-2xl border border-emerald-100 dark:border-emerald-900/30 text-center">
                  ...
                  <h3 className="text-3xl font-black text-gray-900 dark:text-white mt-3">453</h3>
          ...
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 p-6 md:p-8 rounded-[28px] shadow-sm space-y-6">
              <div>
                ...
                <p className="text-xs text-gray-500">
                  Total cumulative admission breakdown across all stages of processing for the current academic session.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
                <div className="bg-gray-50 dark:bg-gray-800/60 p-5 rounded-2xl border border-gray-200 dark:border-gray-700">
                  ...
                  <h3 className="text-2xl font-black text-gray-900 dark:text-white mt-2">18,542</h3>
                ...
                <div className="bg-gray-50 dark:bg-gray-800/60 p-5 rounded-2xl border border-gray-200 dark:border-gray-700">
                  ...
                  <h3 className="text-2xl font-black text-gray-900 dark:text-white mt-2">16,072</h3>
                ...
                <div className="bg-gray-50 dark:bg-gray-800/60 p-5 rounded-2xl border border-gray-200 dark:border-gray-700">
                  ...
                  <h3 className="text-2xl font-black text-gray-900 dark:text-white mt-2">35,963</h3>
                ...
                <div className="bg-gray-50 dark:bg-gray-800/60 p-5 rounded-2xl border border-gray-200 dark:border-gray-700">
                  ...
                  <h3 className="text-2xl font-black text-gray-900 dark:text-white mt-2">{acceptedD.toLocaleString()}</h3>
                ...
                <div className="bg-gradient-to-br from-blue-600 to-indigo-900 text-white p-5 rounded-2xl shadow-lg flex flex-col justify-between">
                  <div>
                    ...
                    <h3 className="text-3xl font-black mt-2">{totalAdmissions.toLocaleString()}</h3>
                  </div>
