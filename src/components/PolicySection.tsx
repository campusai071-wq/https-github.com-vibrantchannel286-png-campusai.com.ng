      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="space-y-6">
          <div className="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700">
            ...
            <p className="text-gray-600 dark:text-slate-300">These are the "Minimum Admissible Scores." While schools can set their own marks higher, they are strictly prohibited from admitting anyone below these benchmarks.</p>
          ...
          <div className="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700">
            ...
            <p className="text-gray-600 dark:text-slate-300">For NCE and Agriculture (non-engineering) candidates, you only need 4 O'Level credit passes in relevant subjects. You must still register with JAMB for verification and processing through CAPS.</p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700">
            ...
            <ul className="text-gray-600 dark:text-slate-300 space-y-2">
          ...
          <div className="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700">
            ...
            <p className="text-gray-600 dark:text-slate-300">Minimum age is 16 by September 30, 2026. For CAPS, once offered admission, you have exactly 4 weeks to accept or reject it.</p>
          </div>
        </div>
      </div>
    </section>
